...
def app_layout(self):
    ...
    for i in range(len(appList)):
        self.button.append(Button(self, text=appList[i], width=16, height=8, bd='0', command=lambda i=i: open_app(i)))
        self.button[i].config(bg="#22303C", fg="#888888", highlightthickness=2, highlightbackground="orange", highlightcolor="orange", font=buttonFont)
